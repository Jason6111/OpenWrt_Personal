...
mkdir -p ./feeds/packages/helloworld/hysteria/patches/ && && curl -o ./feeds/packages/helloworld/hysteria/patches/0001-go-get-github.com-quic-go-quic-go-v0.37.6.patch https://raw.githubusercontent.com/coolsnowwolf/packages/master/net/adguardhome/patches/0001-go-get-github.com-quic-go-quic-go-v0.37.6.patch
#dockerman
